...
<div class="content-card">
    <div class="content-card-body" style="padding: 20px;">
        <form action="<?= base_url('admin/edit_wisata_aksi') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group" style="margin-bottom: 15px;">
                ...
                <?php if (!empty($wisata->file_gambar)) : ?>
                    <div style="margin-bottom: 15px;">
                        <div style="display: flex; align-items: center; justify-content: center; width: 250px; height: 250px; background: #f0f0f0; border-radius: 8px; overflow: hidden; margin-bottom: 10px;">
                            <img src="<?= base_url('assets/images/wisata/' . $wisata->file_gambar) ?>" alt="<?= htmlspecialchars($wisata->nama_wisata) ?>" style="width: 100%; height: 100%; object-fit: cover;">
                        </div>
                        <p style="margin: 0; font-size: 0.9em; color: #666;">Foto saat ini</p>
                    </div>
                <?php endif; ?>
                <div style="display: flex; align-items: center; justify-content: center; width: 100%; max-width: 250px; aspect-ratio: 1; background: #f9f9f9; border: 2px dashed #ddd; border-radius: 8px; overflow: hidden; cursor: pointer;" id="image-preview-container" onclick="document.getElementById('file_gambar').click();">
                ...
                <small style="color: #666; margin-top: 10px; display: block;">Format: JPG, PNG, GIF. Ukuran maksimal: 2MB. Kosongkan jika tidak ingin mengganti foto.</small>
            </div>
